      ...
      <thead>
          ...
          @foreach($category->items as $item)
             <tr>
                ...
                <td> <a href='javascript:editarItem({{$item->id}},"{{$item->name}}",{{$item->price}},"{{$item->description}}","{{$category->id}}")' class="btn btn-default btn-xs"><i class="icon-pencil"></i> editar</a></td>
