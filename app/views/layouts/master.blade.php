...
<div class="side-bar-wrapper collapse navbar-collapse navbar-ex1-collapse">
  ...
  <div class="relative-w">
    <ul class="side-menu">
      <li id ='user'>
        <a href="http://localhost/restapp-rest/public/index.php/users">
          <span class="badge pull-right"></span>
          <i class="icon-group"></i> Usuarios
        </a>
      </li>
      <li id='order'>
        <a href="http://localhost/restapp-rest/public/index.php/orders">
          <span class="badge pull-right">12</span>
          <i class="icon-pencil"></i> Ordenes
        </a>
      </li>
      <li id='item'>
        <a href="http://localhost/restapp-rest/public/index.php/items">
          <span class="badge pull-right"></span>
          <i class="icon-code-fork"></i> Items
        </a>
      </li>
      <li id='cat'>
        <a href="http://localhost/restapp-rest/public/index.php/categorias">
          <span class="badge pull-right">24</span>
          <i class="icon-th"></i> Categorias
        </a>
      </li>
      <li id='table'>      
        <a href="http://localhost/restapp-rest/public/index.php/tables">
          <span class="badge pull-right"></span>
          <i class="icon-table"></i> Mesas
        </a>
      </li>
      <li id='res'><a href="http://localhost/restapp-rest/public/index.php/reservas">
...
<div class="content-inner">
  ...
  <div class="header-links hidden-xs">
    <a href="http://localhost/restapp-rest/public/index.php/cocina"><i class="icon-comments"></i> Cocina</a>
